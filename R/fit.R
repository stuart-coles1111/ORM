...
#' @examples
#'   fit("gum", 5, ski_data,first_Run =FALSE, allranks=FALSE, maxrank=15, if_hessian=FALSE, init=0.1, method="BFGS", print=FALSE)
#'
#' @export
#'
fit <- function(model_type = "gum", model_number = 1, race_df = ski_data, first_Run = TRUE, second_Run = TRUE, allranks = TRUE, maxrank = 10,  exclude_second_Run=NULL, if_hessian = FALSE, init = 0, method = "BFGS", transform = TRUE, print = FALSE){
